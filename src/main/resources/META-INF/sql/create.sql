...
create table Competencia (id_competencia integer not null auto_increment, acepta_empates bit, cant_sets integer, eliminada bit, Estado integer, fecha_elim date, modalidad integer, nom_comp varchar(255), otorga_tantos bit, pts_part_empatado integer, pts_partido_ganado integer, pts_por_presentarse integer, reglas_comp TEXT, sistemaPuntuacion integer, tantos_a_favor_por_no_presentarse integer, id_deporte integer, id_fixture integer, id_usuario integer, primary key (id_competencia));
